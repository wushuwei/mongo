...
func ConnetFinnhubPattern() {

	client := http.Client{}
	patternRecognition := "https://finnhub.io/api/v1/scan/pattern?symbol=TSLA&resolution=5&token=c17bkh748v6se55vr9eg"
